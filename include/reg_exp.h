...
public:
	...
	const char* Search(const char *sampleString, int* resLen);	// Returns a pointer to the beginning of the matched part and sets resLen to store the length of the mathced part.
};
